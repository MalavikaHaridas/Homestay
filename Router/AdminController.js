...
export const adminhome = async(req, res) => {
    // StaffModel.find({}).lean().exec((err, staffdetails) => {
    //     if (err) {
    //         console.log(err);
    //     }
    //     console.log("staffdetails", staffdetails)
    //     res.render('adminhome', { staffdetails })
    // })
    let staffdetails=await StaffModel.findOne({admin:temp_admin.id})
    res.render('adminhome',{staffdetails})
...
export const guestdata = (req, res) => {
